    ...
    <div class="register-form">
        ...
        <div class="form-container">
            ...
            <form id="registerForm"  onsubmit="return validateForm()">
                ...
                <p class="text-center" style="margin-top: 10px;">Merhaba,<br> Hemen hesap oluştur, alışverişe başla!</p>
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="telNo" id="telNo" onkeyup="telcontrol()" placeholder="Telefon numaranızı giriniz" required>
    ...
    <div class="login-form" style="display: none;">
        ...
        <div class="form-container">
            <form id="loginForm" action="giris_yap.php" method="post">
                ...
                <p class="text-center" style="margin-top:10px;">Merhaba gezgin,<br> Hemen giriş yap, alışverişe başla!</p>
                <div class="row justify-content-center">
                    <div class="col-md-10">

                        <div class="form-group">
                            <p style="color: red;" id="login_error"></p>
                            <label for="g_email">E-posta/Telefon numarası: </label>
                            <input type="email" class="form-control" name="g_email" id="g_email" placeholder="Giriş bilginizi girin" required>
                        </div>
